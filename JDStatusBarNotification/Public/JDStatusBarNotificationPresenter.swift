...
public extension NotificationPresenter {
  ...
  ///
  func present(_ title: String, subtitle: String? = nil, delay: Double? = nil, styleName: String? = nil, completion: NotificationPresenterCompletion? = nil) -> UIView {
  ...
  /// - Returns: The presented UIView for further customization
  ///
  func present(_ title: String, subtitle: String? = nil, delay: Double? = nil, includedStyle: IncludedStatusBarNotificationStyle, completion: NotificationPresenterCompletion? = nil) -> UIView {
  ...
  ///
  func dismiss(delay: Double? = nil, completion: NotificationPresenterCompletion? = nil) {
    if let delay {
  ...
  /// Adds a new custom style based on a specific included style, if given. This can be used by referencing it using the `styleName`.
  ///
  ...
  ///
  func addStyle(named name: String, usingStyle includedStyle: IncludedStatusBarNotificationStyle? = nil, prepare: NotificationPresenterPrepareStyleClosure) -> String {
